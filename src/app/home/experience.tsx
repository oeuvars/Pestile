...
const Experience: React.FC = () => {
  return (
    <div id='features' className='pt-[5vw]'>
      ...
      <div className='phone:w-[90%] md:w-[78%] mx-auto grid tablet:grid-cols-3 phone:gap-[2vh] md:gap-[2vw] phone:mt-[4vh] md:mt-[3vw]'>
         <div className='grid border-2 border-[#F1E9DF] bg-[#FFFAF1] upper-card-shadow rounded-3xl phone:gap-[3vh] md:gap-0 px-[1vw] phone:pt-[2.5vh] md:pt-[2.5vw] phone:pb-[5vh] md:pb-[3vw]'>
            ...
            <div className='w-[90%] mx-auto'>
               <h1 className='font-gambarino phone:text-2xl md:text-4xl text-center text-[#1E1B13]'>Get Ready</h1>
               ...
               <hr className='w-[10%] border-[#000] mx-auto phone:mt-[3vh] tablet:mt-0'/>
            </div>
         </div>
         <div className='grid border-4 border-[#F1E9DF] bg-[#FFFAF1] upper-card-shadow rounded-3xl phone:gap-[3vh] md:gap-0 px-[1vw] phone:pt-[2.5vh] md:pt-[2.5vw] phone:pb-[5vh] md:pb-[3vw]'>
            ...
            <div className='w-[90%] mx-auto'>
               <h1 className='font-gambarino phone:text-2xl md:text-4xl text-center text-[#1E1B13]'>Journey Plan</h1>
               <p className='font-satoshi-regular text-center phone:text-base md:text-lg text-[#80796B] phone:my-[1vh] md:my-[1vw] phone:leading-5 md:leading-tight'>
         ...
         <div className='grid border-4 border-[#F1E9DF] bg-[#FFFAF1] upper-card-shadow rounded-3xl phone:gap-[3vh] md:gap-0 px-[1vw] phone:pt-[2.5vh] md:pt-[2.5vw] phone:pb-[5vh] md:pb-[3vw]'>
            ...
            <div className='mx-auto w-[90%]'>
               <h1 className='font-gambarino phone:text-2xl md:text-4xl text-center text-[#1E1B13]'>Tailored stays</h1>
               <p className='font-satoshi-regular text-center phone:text-base md:text-lg text-[#80796B] phone:my-[1vh] md:my-[1vw] phone:leading-5 md:leading-tight'>
      ...
      <div className='phone:w-[90%] md:w-[78%] mx-auto grid tablet:grid-cols-2 phone:gap-[2vh] md:gap-[2vw] phone:mt-[2vh] md:mt-[2vw] phone:mb-[5vh] lg:mb-[5vw]'>
         <div className='grid border-4 border-[#F1E9DF] bg-[#FFFAF1] lower-card-shadow rounded-3xl phone:gap-[3vh] md:gap-[1.5vw] px-[1vw] phone:pt-[2.5vh] md:pt-[2.5vw] phone:pb-[5vh] md:pb-[3vw]'>
            <img src='/images/experience/card-4.webp' alt='camera' className='py-[1.5vw] px-[2vw] mx-auto'/>
            <div className='w-[90%] mx-auto'>
               <h1 className='font-gambarino phone:text-2xl md:text-4xl text-center text-[#1E1B13]'>Welcoming helpers</h1>
               <p className='font-satoshi-regular text-center phone:text-base md:text-lg text-[#80796B] phone:my-[1vh] md:my-[1vw] phone:leading-5 md:leading-tight'>
         ...
         <div className='grid border-4 border-[#F1E9DF] bg-[#FFFAF1] lower-card-shadow rounded-3xl phone:gap-[3vh] md:gap-[1.5vw] px-[1vw] phone:pt-[2.5vh] md:pt-[2.5vw] phone:pb-[5vh] md:pb-[3vw]'>
            ...
            <div className='w-[90%] mx-auto'>
               <h1 className='font-gambarino phone:text-2xl md:text-4xl text-center text-[#1E1B13]'>Relax and enjoy yourself</h1>
               <p className='font-satoshi-regular text-center phone:text-base md:text-lg text-[#80796B] phone:my-[1vh] md:my-[1vw] phone:leading-5 md:leading-tight'>
