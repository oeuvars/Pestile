...
const Experience: React.FC = () => {
  return (
    <div>
      <h1 className='font-dynalight text-7xl text-center'>Experience a new era</h1>
      <p className='font-satoshi-regular text-[#80796B] text-xl my-[1.5vw] text-center'>
      ...
      <div className='w-[78%] mx-auto grid grid-cols-3 gap-[2vw] mt-[5vw]'>
         <div className='grid border-2 border-[#F1E9DF] bg-[#FFFAF1] upper-card-shadow rounded-3xl px-[1vw] pt-[2.5vw] pb-[3vw]'>
            ...
            <div>
               <h1 className='font-gambarino text-4xl text-center'>Get Ready</h1>
               <p className='font-satoshi-regular text-center text-lg text-[#80796B] my-[1vw] leading-tight'>
                  Your role? To anticipate a seamless,
                  <br />
                  stress-free journey, with every detail
                  <br />
                  attended to, effortlessly.
               </p>
         ...
         <div className='grid border-4 border-[#F1E9DF] bg-[#FFFAF1] upper-card-shadow rounded-3xl px-[1vw] pt-[1vw] pb-[3vw] gap-[0.5vw]'>
            ...
            <div>
               <h1 className='font-gambarino text-4xl text-center'>Journey Plan</h1>
               <p className='font-satoshi-regular text-center text-lg text-[#80796B] my-[1vw] leading-tight'>
                  The app will craft your entire journey.
                  <br />
                  It's like having a travel expert in your
                  <br />
                  pocket, that can modify any detail
                  <br />
                  instantly.
               </p>
               <hr className='w-[10%] border-[#000] mx-auto'/>
         ...
         <div className='grid border-2 border-[#F1E9DF] bg-[#FFFAF1] upper-card-shadow rounded-3xl px-[1vw] pt-[1vw] pb-[3vw] gap-[0.5vw]'>
            ...
            <div>
               <h1 className='font-gambarino text-4xl text-center'>Tailored stays</h1>
               <p className='font-satoshi-regular text-center text-lg text-[#80796B] my-[1vw] leading-tight'>
      ...
      <div className='w-[78%] mx-auto grid grid-cols-2 gap-[2vw] mt-[2vw] mb-[5vw]'>
         <div className='grid border-4 border-[#F1E9DF] bg-[#FFFAF1] lower-card-shadow rounded-3xl px-[1vw] py-[3vw] gap-[1.5vw]'>
            ...
            <div className=''>
               <h1 className='font-gambarino text-4xl text-center'>Welcoming helpers</h1>
               <p className='font-satoshi-regular text-center text-lg text-[#80796B] my-[1vw] leading-tight'>
         ...
         <div className='grid border-4 border-[#F1E9DF] bg-[#FFFAF1] lower-card-shadow rounded-3xl px-[1vw] py-[3vw] gap-[1.5vw]'>
            ...
            <div className='w-[90%] mx-auto'>
               <h1 className='font-gambarino text-4xl text-center'>Relax and enjoy yourself</h1>
               <p className='font-satoshi-regular text-center text-lg text-[#80796B] my-[1vw] leading-tight'>
