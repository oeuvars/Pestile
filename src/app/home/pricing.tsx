...
const Pricing: React.FC = () => {
  ...
  return (
    <div>
      ...
      <h1 className='font-dynalight text-7xl text-center mt-[7vw]'>Pricing designed with you in mind</h1>
      ...
      <div className='flex rounded-full bg-[#F1EBDF] w-[16%] mx-auto my-[2.5vw] justify-between py-[0.25vw] px-[0.25vw] text-lg animation'>
      ...
      <div className='w-[78%] mx-auto gap-[2vw] grid grid-cols-3 mt-[4vw]'>
         <div className='flex flex-col border-4 border-[#F1E9DF] bg-[#FFFAF1] lower-card-shadow rounded-3xl px-[2vw] py-[2.5vw]'>
            ...
            <h1 className='font-gambarino text-7xl text-center mt-[2.5vw]'>Free</h1>
            ...
            <div className='mt-auto'>
               ...
               <button className='mt-[1vw] py-2 px-7 bg-[#FFFAF1] rounded-[9px] shadow-sm border-2 border-[#F1E9DF] hover:shadow-[#FF878C]/40 hover:shadow-md animation font-satoshi-medium text-neutral-800 text-lg w-[90%] mx-auto'>
                  Start for free
               </button>
            </div>
         </div>
         <div className='flex flex-col border-4 border-[#F1E9DF] bg-[#FFFAF1] lower-card-shadow rounded-3xl px-[2vw] py-[2.5vw]'>
            ...
            <h1 className='font-gambarino text-7xl text-center mt-[2.5vw]'>{price}<span className='text-4xl'>.99&nbsp;</span><span className='font-satoshi-medium text-lg text-[#80796B]'>/{duration}</span></h1>
            <hr className='border-[#F1EBDF] border mt-[3vw] mb-[2vw]'/>
            <div className='grid gap-[1vw]'>
               <div className='flex gap-2'>
                  <img src='/icons/tick-circle.svg' alt='tick' className='w-6 h-6 mt-1'/>
            ...
            <button className='mt-auto py-2 px-7 bg-[#FFFAF1] rounded-[9px] shadow-sm border-2 border-[#F1E9DF] hover:shadow-[#FF878C]/40 hover:shadow-md animation font-satoshi-medium text-neutral-800 text-lg w-full'>
               Start monthly plan
            </button>
         </div>
         <div className='border-4 border-[#F1E9DF] bg-[#FFFAF1] lower-card-shadow rounded-3xl px-[2vw] py-[2.5vw]'>
            ...
            <h1 className='font-gambarino text-7xl text-center mt-[2.5vw]'>{proPrice}<span className='text-4xl'>.99&nbsp;</span><span className='font-satoshi-medium text-lg text-[#80796B]'>/{duration}</span></h1>
            <hr className='border-[#F1EBDF] border mt-[3vw] mb-[2vw]'/>
